...
from node import ( Node, Host, OVSKernelSwitch, DefaultController,
                           Controller )
...
class Mininet( object ):
    ...
    def addHost( self, name, cls=None, ctrl=None, **params ):
        """Add host.
    ...
    def addSwitch( self, name, cls=None, ctrl=None, **params ):
        """Add switch.
